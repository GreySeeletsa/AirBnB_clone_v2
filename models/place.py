...
class Place(BaseModel, Base):
    """Representing the Place for MySQL database.

    Inheriting from the SQLAlchemy Base and links to MySQL table places.

    Attributes:
        __tablename__ (str): A name of ySQL table to store places.
        ...
        max_guest (sqlalchemy Integer): A maximum number of guests.
        ...
        amenity_ids (list): The id list of all the linked amenities.
    """
    ...
    if getenv("HBNB_TYPE_STORAGE", None) != "db":
        @property
        def reviews(self):
            """Getting the list of all the linked Reviews."""
            review_list = []
        ...
        @property
        def amenities(self):
            """To get or set linked Amenities."""
            amenity_list = []
