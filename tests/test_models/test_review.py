#!/usr/bin/python3
"""This defines the unnittests for models/review.py."""
import os
import pep8
import models
import MySQLdb
...
class TestReview(unittest.TestCase):
    """The unittests for testing Review class."""

    @classmethod
    def setUpClass(cls):
        """Reviewing the testing setup.
        Temporary renames any existing of file.json.
        Reseting the FileStorage objects dictionary.
        Creating the FileStorage, DBStorage and the Review instances for testing.
        """
        try:
    ...
    def tearDownClass(cls):
        """Reviewing the testing teardown.
        Restores the original file.json.
        Deletes a FileStorage, DBStorage and the Review test instances.
        """
        try:
            os.remove("file.json")
        except IOError:
    ...
    def test_nullable_attributes(self):
        """Tests whether the email attribute is non-nullable."""
    ...
    def test_is_subclass(self):
        """Checks whether the Review is the subclass of BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Tests whether the different Review instances are unique."""
        us = Review(email="a", password="a")
    ...
    def test_save_filestorage(self):
        """Tests the save method with the FileStorage."""
    ...
    def test_save_dbstorage(self):
        """Tests the save method with DBStorage."""
        old = self.review.updated_at
        self.state.save()
        self.city.save()
        self.user.save()
