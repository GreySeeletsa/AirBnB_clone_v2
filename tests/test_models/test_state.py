#!/usr/bin/python3
"""This defines the unnittests for models/state.py."""
import os
import pep8
import models
import MySQLdb
...
class TestState(unittest.TestCase):
    """The Unittests for testing the State class."""

    @classmethod
    def setUpClass(cls):
        """The State testing setup.

        Temporary renames any of existing file.json.
        Reseting the FileStorage objects dictionary.
        Creating the FileStorage, DBStorage and State instances for testing.
        """
        try:
    ...
    def test_nullable_attributes(self):
        """Checks whether the relevant DBStorage attributes are non-nullable."""
    ...
    def test_is_subclass(self):
        """Checks whether the State is a subclass of BaseModel."""
    ...
    def test_two_models_are_unique(self):
        """Tests whetehr the different State instances are unique."""
        st = State()
