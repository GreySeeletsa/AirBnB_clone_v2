...
class test_Place(test_basemodel):
    ...
    def test_description(self):
        """tests the place description attr"""
        new = self.value()
    ...
    def test_number_rooms(self):
        """ tests the place number of the rooms attr"""
        new = self.value()
    ...
    def test_number_bathrooms(self):
        """ tests the place number of the bathrooms attr"""
        new = self.value()
    ...
    def test_max_guest(self):
        """ tests the place max_guest attr"""
        new = self.value()
    ...
    def test_price_by_night(self):
        """ tests the place price by the night attr"""
        new = self.value()
    ...
    def test_longitude(self):
        """ tests the place longitude attr"""
        new = self.value()
        self.assertEqual(type(new.latitude), float if
                         os.getenv('HBNB_TYPE_STORAGE') != 'db' else
                         type(None))
