#!/usr/bin/python3
"""Module that tests file storage"""
import os
import json
import pep8
import unittest
...
class TestFileStorage(unittest.TestCase):
    """unittests to test the FileStorage class"""
    ...
    def test_all_cls(self):
        """tests the all method with a specified cls"""
    ...
    def test_delete_nonexistant(self):
        """tests the del method with nonexistent obj"""
        try:
